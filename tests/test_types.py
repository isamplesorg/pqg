...
typeish_cases = (
    ...
    (
        typing.Union[dict, typing.ForwardRef("GeospatialCoordLocation"), None],
        None,
        False,
        True,
    ),
    ...
    (
        typing.Union[bool, linkml_runtime.utils.metamodelcore.Bool, None],
        bool,
        False,
        False,
    ),
    (
        typing.Union[
            str,
            linkml_runtime.utils.metamodelcore.URIorCURIE,
            typing.List[
                typing.Union[str, linkml_runtime.utils.metamodelcore.URIorCURIE]
            ],
            None,
        ],
        str,
    ...
    (
        typing.Union[
            dict,
            isamples.generated.Agent,
            typing.List[typing.Union[dict, isamples.generated.Agent]],
            None,
        ],
        None,
        True,
